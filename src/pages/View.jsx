...
export default function View() {
  ...
  const handleVitalsChange = (field, value) => setVitals((prev) => ({ ...prev, [field]: value }));
            ...
            <div className="flex items-center gap-2">
              {!isEditing ? (
                ...
                <>
                  ...
                  <button className={btnBlue} onClick={handleEdit}>Save</button>
                </>
              )}
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 px-6 py-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xl font-semibold">{appointment.patient_name} <span className="text-white/80 text-sm">({appointment.patient_id ?? "—"})</span></div>
                </div>
              </div>
                ...
                {caseStudies.map((caseStudy, index) => (
                  <div key={index} className="animate-fadeUp">
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-sm text-gray-900">{caseStudy || "—"}</p>
                    )}
                  </div>
                ))}
              </div>
                ...
                {prescriptions.map((prescription, index) => (
                  <div key={index} className="animate-fadeUp">
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-sm text-gray-900">{prescription || "—"}</p>
                    )}
                  </div>
                ))}
              </div>
